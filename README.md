...
This web app is an implementation of my undergraduate thesis titled “GSNet: A Multi-class 3D Attention-based Hybrid Glioma Segmentation Network”. It involves the segmentation of Glioma from 3D volumetric MRI images. (https://ieeexplore.ieee.org/abstract/document/9524617). The automation of the Breast Cancer detection framework has been accomplished in this article. [Description]([https://github.com/006jawad/Breast-Cancer-Classification](https://github.com/006jawad/GSNet)). (Material used: Python, HTML, CSS, JS)
...
## Breast Cancer Classification Using Ensemble of Machine Learning Boosting Algorithms
